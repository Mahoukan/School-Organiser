...
export async function getSchoolData(userId) {
  ...
  if (!academicYear) return { academicYear: null, terms: [], teachingWeeks: [], classes: [], dayTimetableTemplates: [], dayTimetableTemplateBlocks: [], dayTimetableAssignments: [], timetableBlocks: [], recurringAssignments: [], historicalRecurringAssignments: [], recurringEvents: [], lessonOccurrences: [], teacherAbsences: [], classAbsences: [], calendarExceptions: [], lessonMovements: [] };
  const [termRows, classRows, templateRows, templateBlockRows, dayAssignmentRows, blockRows, recurringRows, lessonRows, teacherRows, absenceRows, exceptionRows, movementRows] = await Promise.all([
