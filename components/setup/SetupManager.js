...
export default function SetupManager() {
  ...
  return (
    <section className={styles.setupPage} aria-labelledby="setup-title">
      <header className={styles.pageHeader}><h1 id="setup-title">Setup</h1><p>Configure period structures and your recurring timetable.</p></header>
      <div className={styles.setupTabs} aria-label="Setup area">
        <button type="button" aria-pressed={area === "periods"} onClick={() => setArea("periods")}>Period Structures</button>
